...
module CHIP ( clk, reset, rom_q, rom_a, sram_q, sram_a, sram_d, sram_wen, 
        finish );
  ...
  wire i_sram_wen,  i_finish;
  wire [6:0]  i_rom_a;
  wire [9:0]  i_sram_a;
  wire [7:0]  i_sram_d;

CLE CLE( .clk(i_clk), .reset(i_reset), .rom_q(i_rom_q), .rom_a(i_rom_a), .sram_q(i_sram_q), .sram_a(i_sram_a), .sram_d(i_sram_d), .sram_wen(i_sram_wen), 
        .finish(i_finish) );
  ...
  PDIDGZ ipad_rom_q0 (.PAD(rom_q[0]), .C(i_rom_q[0]));
  PDIDGZ ipad_rom_q1 (.PAD(rom_q[1]), .C(i_rom_q[1]));
  PDIDGZ ipad_rom_q2 (.PAD(rom_q[2]), .C(i_rom_q[2]));
  PDIDGZ ipad_rom_q3 (.PAD(rom_q[3]), .C(i_rom_q[3]));
  PDIDGZ ipad_rom_q4 (.PAD(rom_q[4]), .C(i_rom_q[4]));
  PDIDGZ ipad_rom_q5 (.PAD(rom_q[5]), .C(i_rom_q[5]));
  PDIDGZ ipad_rom_q6 (.PAD(rom_q[6]), .C(i_rom_q[6]));
  PDIDGZ ipad_rom_q7 (.PAD(rom_q[7]), .C(i_rom_q[7]));
  
  PDIDGZ ipad_sram_q0 (.PAD(sram_q[0]), .C(i_sram_q[0]));
  PDIDGZ ipad_sram_q1 (.PAD(sram_q[1]), .C(i_sram_q[1]));
  PDIDGZ ipad_sram_q2 (.PAD(sram_q[2]), .C(i_sram_q[2]));
  PDIDGZ ipad_sram_q3 (.PAD(sram_q[3]), .C(i_sram_q[3]));
  PDIDGZ ipad_sram_q4 (.PAD(sram_q[4]), .C(i_sram_q[4]));
  PDIDGZ ipad_sram_q5 (.PAD(sram_q[5]), .C(i_sram_q[5]));
  PDIDGZ ipad_sram_q6 (.PAD(sram_q[6]), .C(i_sram_q[6]));
  PDIDGZ ipad_sram_q7 (.PAD(sram_q[7]), .C(i_sram_q[7]));
  
  
  
  PDO12CDG opad_sram_wen (.I(i_sram_wen), .PAD(sram_wen));
  PDO12CDG opad_finish (.I(i_finish), .PAD(finish));
  
  
  
  PDO12CDG opad_rom_a0 (.I(i_rom_a[0]), .PAD(rom_a[0]));
  PDO12CDG opad_rom_a1 (.I(i_rom_a[1]), .PAD(rom_a[1]));
  PDO12CDG opad_rom_a2 (.I(i_rom_a[2]), .PAD(rom_a[2]));
  PDO12CDG opad_rom_a3 (.I(i_rom_a[3]), .PAD(rom_a[3]));
  PDO12CDG opad_rom_a4 (.I(i_rom_a[4]), .PAD(rom_a[4]));
  PDO12CDG opad_rom_a5 (.I(i_rom_a[5]), .PAD(rom_a[5]));
  PDO12CDG opad_rom_a6 (.I(i_rom_a[6]), .PAD(rom_a[6]));
  
  PDO12CDG opad_sram_a0 (.I(i_sram_a[0]), .PAD(sram_a[0]));
  PDO12CDG opad_sram_a1 (.I(i_sram_a[1]), .PAD(sram_a[1]));
  PDO12CDG opad_sram_a2 (.I(i_sram_a[2]), .PAD(sram_a[2]));
  PDO12CDG opad_sram_a3 (.I(i_sram_a[3]), .PAD(sram_a[3]));
  PDO12CDG opad_sram_a4 (.I(i_sram_a[4]), .PAD(sram_a[4]));
  PDO12CDG opad_sram_a5 (.I(i_sram_a[5]), .PAD(sram_a[5]));
  PDO12CDG opad_sram_a6 (.I(i_sram_a[6]), .PAD(sram_a[6]));
  PDO12CDG opad_sram_a7 (.I(i_sram_a[7]), .PAD(sram_a[7]));
  PDO12CDG opad_sram_a8 (.I(i_sram_a[8]), .PAD(sram_a[8]));
  PDO12CDG opad_sram_a9 (.I(i_sram_a[9]), .PAD(sram_a[9]));
  
  PDO12CDG opad_sram_d0 (.I(i_sram_d[0]), .PAD(sram_d[0]));
  PDO12CDG opad_sram_d1 (.I(i_sram_d[1]), .PAD(sram_d[1]));
  PDO12CDG opad_sram_d2 (.I(i_sram_d[2]), .PAD(sram_d[2]));
  PDO12CDG opad_sram_d3 (.I(i_sram_d[3]), .PAD(sram_d[3]));
  PDO12CDG opad_sram_d4 (.I(i_sram_d[4]), .PAD(sram_d[4]));
  PDO12CDG opad_sram_d5 (.I(i_sram_d[5]), .PAD(sram_d[5]));
  PDO12CDG opad_sram_d6 (.I(i_sram_d[6]), .PAD(sram_d[6]));
  PDO12CDG opad_sram_d7 (.I(i_sram_d[7]), .PAD(sram_d[7]));
